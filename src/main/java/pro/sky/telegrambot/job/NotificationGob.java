...
@Component
public class NotificationGob {
    private Logger logger = LoggerFactory.getLogger(NotificationGob.class);

    private final NotificationTaskRepository notificationTaskRepository;
    private final MessageSender messageSender;

    public NotificationGob(NotificationTaskRepository notificationTaskRepository, MessageSender messageSender) {
    ...
    public void sendNotifications(){
        ...
        logger.info("{} task have been found", notificationsTasks.size());
